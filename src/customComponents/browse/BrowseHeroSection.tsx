...
function BrowseHeroSection() {
  return (
    <main className="md:h-[70dvh] h-fit">
        ...
        <motion.div
          ...
          <div className="container mx-auto px-6 text-center md:text-left  pt-20 h-fit pb-10 ">
            ...
            <p className="text-lg md:text-xl  mb-8">
              ...
              <span className="font-semibold ">UI Gallery</span>, crafted by
              users like you. Add your own components or use and download others
            ...
            <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6 ">
              <div className="bg-white/10 backdrop-blur-lg backdrop-blur-safari p-6 rounded-lg shadow-lg">
                ...
                <p className="">
                  All components are free to use and customize for your
                  projects.
                </p>
              </div>
              <div className="bg-white/10 backdrop-blur-lg backdrop-blur-safari p-6 rounded-lg shadow-lg">
